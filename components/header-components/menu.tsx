    ...
    <Sheet>
      ...
      <SheetContent className="py-8">
        ...
        <div className="grid gap-4 py-6 mb-2 mx-2">
          <Link
            href={"/search-person"}
            className="flex items-center gradient-bg justify-center dark:bg-gradient-to-r  place-self-center dark:from-purple-500 dark:via-indigo-500 dark:to-cyan-400 border-0
                   rounded-full text-white text-lg w-fit p-[4px] whitespace-nowrap cursor-pointer transition-transform duration-300 hover:outline-none active:scale-90"
          >
            <SheetTrigger>
              <SearchBar />
            </SheetTrigger>
